  ...
  return (
    <div className="relative">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.3fr_1fr] lg:gap-10">
        {/* Image */}
        <div className="relative h-[22rem] overflow-hidden rounded-2xl shadow-2xl shadow-black/30 sm:h-[26rem] lg:h-[34rem]">
          {enabledOptions.map((option, i) => (
            <img
              key={option.id}
              src={option.image}
      ...
      <div className="mt-16 text-center">
        <p className="mx-auto max-w-3xl font-serif text-2xl font-light leading-relaxed text-cream-50/90 sm:text-3xl lg:text-4xl">
          {data.final_message}
        </p>
        <button
          onClick={handleCta}
